...
Mitosiz.Site.StarRules.Index.Controller = function () {
    ...
    base.Control = {
        ...
        txtMinimumVIP200: function () { return $('#txtMinimumVIP200'); },
        btnUpdateModal: function () { return $('#btnUpdateModal'); },
        btnCreateModal: function () { return $('#btnCreateModal'); },
    };
    base.Event = {
        AjaxGetStarRulesVIP200ForAdminSuccess: function (data) {
            if (data) {
                if (data.isSuccess) {
                    base.Parameters.totalPages = data.data.totalPages;
                    base.Function.FillData(data.data.starRulesVIP200ForAdmin);
                }
            }
        },
        AjaxGetDetailStarRulesVIP200ForAdminSuccess: function (data) {
            if (data) {
                if (data.isSuccess) {
        ...
        AjaxUpdateStarRulesVIP200ForAdminSuccess: function (data) {
            if (data) {
                if (data.isSuccess) {
                    base.Control.modalSave().modal('hide');
                    Swal.fire("Excelente !!", "La regla fue actualizada !!", "success")
                    base.Function.GetStarRulesForAdmin();
                }
                else {
        ...
        btnUpdateModalClick: function () {
            base.Ajax.AjaxUpdateStarRulesVIP200ForAdmin.data = {
                starRulesVIP200Id: base.Parameters.starRulesId,
                minimumVIP: base.Control.txtMinimumVIP200().val(),
            };
            base.Ajax.AjaxUpdateStarRulesVIP200ForAdmin.submit();
        },
    };
    base.Ajax = {
        AjaxGetStarRulesVIP200ForAdmin: new Mitosiz.Site.UI.Web.Components.Ajax({
            action: Mitosiz.Site.StarRules.Actions.GetStarRulesVIP200ForAdmin,
            autoSubmit: false,
            onSuccess: base.Event.AjaxGetStarRulesVIP200ForAdminSuccess
        }),
        AjaxGetDetailStarRulesVIP200ForAdmin: new Mitosiz.Site.UI.Web.Components.Ajax({
            action: Mitosiz.Site.StarRules.Actions.GetDetailStarRulesVIP200ForAdmin,
            autoSubmit: false,
            onSuccess: base.Event.AjaxGetDetailStarRulesVIP200ForAdminSuccess
        }),
        AjaxUpdateStarRulesVIP200ForAdmin: new Mitosiz.Site.UI.Web.Components.Ajax({
            action: Mitosiz.Site.StarRules.Actions.UpdateStarRulesVIP200ForAdmin,
            autoSubmit: false,
            onSuccess: base.Event.AjaxUpdateStarRulesVIP200ForAdminSuccess
        }),
    };
    base.Function = {
        ...
        GetStarRulesForAdmin: function () {
            base.Ajax.AjaxGetStarRulesVIP200ForAdmin.data = {
                number: base.Parameters.currentPage,
                size: base.Parameters.sizePagination
            };
            base.Ajax.AjaxGetStarRulesVIP200ForAdmin.submit();
        },
        FillData: function (listData) {
            ...
            listData.forEach(function (data) {
                base.Control.tbodyTable().append('<tr style="text-align: center;">' +
                    ...
                    '<a class="dropdown-item updateData" value="' + data.starRulesVIP200Id + '" href="#">Actualizar</a>' +
                    '</div>' +
                    '</div></td>' +
                    '<td><strong>' + data.starRulesVIP200Id + '</strong></td>' +
                    '<td style="text-align: center !important;">' + data.minimumVIP + '</td>' +
                    '</tr>');
            });
        ...
        clsUpdateDataClick: function () {
            ...
            parentElement.on('click', '.updateData', function () {
                ...
                base.Ajax.AjaxGetDetailStarRulesVIP200ForAdmin.data = {
                    starRulesVIP200Id: starRulesId
                };
                base.Ajax.AjaxGetDetailStarRulesVIP200ForAdmin.submit();
            });
        },
        FillDataModal: function (data) {
            base.Control.txtMinimumVIP200().val(data.minimumVIP);
        },
    };
}