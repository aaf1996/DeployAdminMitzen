ns('Mitosiz.Site.StarPeriod.Index')
Mitosiz.Site.StarPeriod.Index.Controller = function () {
    var base = this;
    base.Initialize = function () {
        base.Function.clsNumberPagination();
        base.Function.GetStarPeriodForAdmin();
    ...
    base.Control = {
        ...
        tbodyTable: function () { return $('#tbodyStar'); },
    ...
    base.Event = {
        ...
        AjaxGetStarPeriodForAdminSuccess: function (data) {
            if (data) {
                if (data.isSuccess) {
                    base.Parameters.totalPages = data.data.totalPages;
                    base.Function.FillData(data.data.starPeriodForAdmin);
                }
            }
        },
        AjaxGetDetailStarPeriodForAdminSuccess: function (data) {
            if (data) {
                if (data.isSuccess) {
        ...
        AjaxUpdateStarPeriodSuccess: function (data) {
            if (data) {
                if (data.isSuccess) {
        ...
        AjaxInsertStarPeriodSuccess: function (data) {
            if (data) {
                if (data.isSuccess) {
                    base.Control.modalSave().modal('hide');
        ...
        btnUpdateModalClick: function () {
            base.Ajax.AjaxUpdateStarPeriod.data = {
                starPeriodId: base.Parameters.starPeriodId,
                periodName: base.Control.txtPeriodName().val(),
                startDateStarPeriod: base.Control.txtInitPeriodDate().val(),
                startHourStarPeriod: base.Control.txtInitPeriodHour().val(),
                endDateStarPeriod: base.Control.txtEndPeriodDate().val(),
                endHourStarPeriod: base.Control.txtEndPeriodHour().val(),
                status: base.Control.slcActive().val(),
            };
            base.Ajax.AjaxUpdateStarPeriod.submit();
        },
        btnCreateModalClick: function () {

            base.Ajax.AjaxInsertStarPeriod.data = {
                periodName: base.Control.txtPeriodName().val(),
                startDateStarPeriod: base.Control.txtInitPeriodDate().val(),
                startHourStarPeriod: base.Control.txtInitPeriodHour().val(),
                endDateStarPeriod: base.Control.txtEndPeriodDate().val(),
            ...
            base.Ajax.AjaxInsertStarPeriod.submit();
        },
    ...
    base.Ajax = {
        AjaxGetStarPeriodForAdmin: new Mitosiz.Site.UI.Web.Components.Ajax({
            action: Mitosiz.Site.StarPeriod.Actions.GetStarPeriodForAdmin,
            autoSubmit: false,
            onSuccess: base.Event.AjaxGetStarPeriodForAdminSuccess
        }),
        AjaxGetDetailStarPeriodForAdmin: new Mitosiz.Site.UI.Web.Components.Ajax({
            action: Mitosiz.Site.StarPeriod.Actions.GetDetailStarPeriodForAdmin,
            autoSubmit: false,
            onSuccess: base.Event.AjaxGetDetailStarPeriodForAdminSuccess
        }),
        AjaxInsertStarPeriod: new Mitosiz.Site.UI.Web.Components.Ajax({
            action: Mitosiz.Site.StarPeriod.Actions.InsertStarPeriod,
            autoSubmit: false,
            onSuccess: base.Event.AjaxInsertStarPeriodSuccess
        }),
        AjaxUpdateStarPeriod: new Mitosiz.Site.UI.Web.Components.Ajax({
            action: Mitosiz.Site.StarPeriod.Actions.UpdateStarPeriod,
            autoSubmit: false,
            onSuccess: base.Event.AjaxUpdateStarPeriodSuccess
        }),
    };
    base.Function = {
        ...
        FillData: function (listData) {
            ...
            listData.forEach(function (data) {
                base.Control.tbodyTable().append('<tr style="text-align: center;">' +
                    ...
                    '<a class="dropdown-item updateData" value="' + data.starPeriodId + '" href="#">Actualizar</a>' +
                    '</div>' +
                    '</div></td>' +
                    '<td><strong>' + data.starPeriodId + '</strong></td>' +
        ...
        clsUpdateDataClick: function () {
            ...
            parentElement.on('click', '.updateData', function () {
                var starPeriodId = $(this).attr('value');
                base.Control.btnUpdateModal().show();
                base.Control.btnCreateModal().hide();
                base.Parameters.starPeriodId = starPeriodId;
                base.Ajax.AjaxGetDetailStarPeriodForAdmin.data = {
                    starPeriodId: starPeriodId
                };
                base.Ajax.AjaxGetDetailStarPeriodForAdmin.submit();
            });
        },
        FillDataModal: function (data) {
            ...
            base.Control.txtInitPeriodDate().datepicker({
                autoclose: true
            }).datepicker("setDate", data.startDateStarPeriod);
            base.Control.txtInitPeriodHour().val(data.startHourStarPeriod);
            base.Control.txtEndPeriodDate().datepicker({
                autoclose: true
            }).datepicker("setDate", data.endDateStarPeriod);
            base.Control.txtEndPeriodHour().val(data.endHourStarPeriod);
        },
